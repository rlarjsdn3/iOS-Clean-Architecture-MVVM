...
class MoviesListViewModelTests: XCTestCase {
    ...
    class SearchMoviesUseCaseMock: SearchMoviesUseCase {
        ...
        typealias ExecuteBlock = (
            ...
            (MoviesPage) -> Void,
            (Result<MoviesPage, any Error>) -> Void
        ) -> Void
    ...
    func test_whenSearchMoviesUseCaseRetrieveEmptyPage_thenViewModelIsEmpty() {
        // given
        ...
        searchMoviesUseCaseMock._execute = { requestValue, _, completion in
            ...
            completion(.success(MoviesPage(page: 1, totelPages: 0, movies: [])))
        }
    ...
    func test_whenSearchMoviesUseCaseRetrieveFirstPage_thenViewModelContainsOnlyFirstPage() {
        // given
        let searchMoviesUseCaseMock = SearchMoviesUseCaseMock()
    ...
    func test_whenSearchMoviesUseCaseRetrieveFirstAndSecondPage_thenViewModelContainsTwoPages() {
        // given
        let searchMoviesUseCaseMock = SearchMoviesUseCaseMock()
